...
const SEED_USERS = [
  ...
  { username: 'qc1', fullName: 'Quinn Quality', email: 'qc1@example.test', role: 'HEAD_OF_QC' as const },
  { username: 'qcuser1', fullName: 'Quinn User', email: 'qcuser1@example.test', role: 'QC_USER' as const },
